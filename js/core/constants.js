...
export const SHOW_START_TIME_OPTIONS = true
...
export const MAX_SAND_PILES = Math.round(140 * WORLD_CONTENT_MULTIPLIER)
export const CHUNK_SAND_PILE_MIN = 1
export const CHUNK_SAND_PILE_MAX = 3
export const SAND_PILE_RESPAWN_BATCH = 2
