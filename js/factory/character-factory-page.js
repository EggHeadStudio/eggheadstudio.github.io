...
const PARAM_SCHEMA = [
  ...
  { key: "eyeSizeScale", label: "Eye Size Scale", type: "numberRange", min: 0.5, max: 1.8, step: 0.01, defaultValue: 1 },
  { key: "eyeCount", label: "Eye Count", type: "numberRange", min: 1, max: 2, step: 1, defaultValue: 2 },
  { key: "blinkEnabled", label: "Blink Enabled", type: "boolean", defaultValue: true },
  { key: "blinkIntervalMs", label: "Blink Interval (ms)", type: "numberRange", min: 1200, max: 8000, step: 10, defaultValue: 3200 },
  { key: "blinkDurationMs", label: "Blink Duration (ms)", type: "numberRange", min: 70, max: 420, step: 5, defaultValue: 150 },
  { key: "eyelidColor", label: "Eyelid Color", type: "color", defaultValue: "#f8cc8e" },
  ...
  { key: "hasNose", label: "Show Nose", type: "boolean", defaultValue: true },
  ...
  { key: "hasMouth", label: "Show Mouth", type: "boolean", defaultValue: true },
  { key: "mouthColor", label: "Mouth Color", type: "color", defaultValue: "#5e3f2c" },
  { key: "mouthWidthScale", label: "Mouth Width Scale", type: "numberRange", min: 0.5, max: 1.8, step: 0.01, defaultValue: 1 },
  { key: "mouthOffsetScale", label: "Mouth Offset Scale", type: "numberRange", min: 0.2, max: 0.8, step: 0.01, defaultValue: 0.44 },
  { key: "mouthCurveScale", label: "Mouth Curve Scale", type: "numberRange", min: -1, max: 1, step: 0.01, defaultValue: 0.34 },
  { key: "hasLips", label: "Show Lips", type: "boolean", defaultValue: true },
  { key: "lipThickness", label: "Lip Thickness", type: "numberRange", min: 0.4, max: 2.2, step: 0.01, defaultValue: 1 },
  { key: "lipColor", label: "Lip Color", type: "color", defaultValue: "#c26f76" },
